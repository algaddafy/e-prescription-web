        ...
        <div class="main">
            ...
            <div class="container">
                <div class="main-body pt-4">
                    <?php
                    $get_info = "SELECT * FROM users JOIN patients USING(user_id) WHERE users.user_id = {$_SESSION['user_id']}";
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <?php
                                                $adult_sql = "SELECT user_id FROM patients WHERE user_id IN (SELECT user_id from patients WHERE age < 18);";
                                                $adult_res = mysqli_query($conn, $adult_sql);
                                                $adult_row = mysqli_fetch_assoc($adult_res);
                                                if ($row['user_id'] == $adult_row['user_id']) {
                                                    echo "Yes";
                                                } else {
                                                    echo "No";
                                                }
